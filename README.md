...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/sicor-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10885&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/sicor-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `sicor` can be installed with:

```
conda install sicor
```

It is possible to list all of the versions of `sicor` available on your platform with:
